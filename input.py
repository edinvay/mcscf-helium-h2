...
if molecule_state == 'excited':
    ...
    Ground_coefficient_file_name = 'general_6_orbital'

    Ground_orbital_file_name = []

    # Repeat for each orbital (ommit extension '.tree'):
    Ground_orbital_file_name.append( 'general_6_orbital_phi_0' )
    Ground_orbital_file_name.append( 'general_6_orbital_phi_1' )
    Ground_orbital_file_name.append( 'general_6_orbital_phi_2' )
    Ground_orbital_file_name.append( 'general_6_orbital_phi_3' )
    Ground_orbital_file_name.append( 'general_6_orbital_phi_4' )
    Ground_orbital_file_name.append( 'general_6_orbital_phi_5' )
